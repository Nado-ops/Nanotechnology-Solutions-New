  ...
  return <Layout>
    <section className="hero-home" data-spotlight>
      <div className="hero-grid-pattern"></div><div className="container hero-home__grid">
        <div className="hero-copy"><p className="hero-trust"><span></span> Operating since 2016</p><p className="hero-service-area">◎ Nationwide Service Across {company.country}</p><h1>Technology That Keeps Your Organisation <em>Connected</em></h1><p>Nanotechnology IT Solutions provides infrastructure, cloud, education technology, software, branding and managed IT services to schools, organisations and growing businesses across {company.country}.</p><div className="button-row"><a className="button button--hero" href="/contact?type=assessment">Request a Site Assessment <span>↗</span></a><a className="button button--outline" href="#services">Explore Our Solutions</a><a className="button button--text" href="/support">Get Technical Support</a></div></div>
        <HeroVisual />
      </div>
      <ReactiveTrustStrip />
    </section>
